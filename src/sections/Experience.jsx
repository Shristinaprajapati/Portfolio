export default function Experience() {
  ...
  return (
<section className="w-full min-h-screen bg-white flex flex-col justify-center pt-4 pb-10 px-3 lg:px-10">
...
<div className="space-y-12">
  {experiences.map((exp, idx) => (
    <div
      key={idx}
      className="flex flex-col md:flex-row md:items-start md:gap-10 ml-2 md:ml-0"
    >
      {/* Left side */}
